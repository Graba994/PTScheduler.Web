...
namespace PTScheduler.Infrastructure.Migrations
{
    ...
    [Migration("20260718130000_AddPayUConfig")]
    partial class AddPayUConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyLesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyLessonProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AcademyLessonProgress");
                });

            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.SiteSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AcademyEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("PayUClientId")
                        .HasColumnType("text");

                    b.Property<string>("PayUClientSecret")
                        .HasColumnType("text");

                    b.Property<bool>("PayUIsSandbox")
                        .HasColumnType("boolean");

                    b.Property<string>("PayUPosId")
                        .HasColumnType("text");

                    b.Property<string>("PayUSecondKey")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyEnrollment", b =>
                {
                    b.HasOne("PTScheduler.Domain.Entities.AcademyCourse", "Course")
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyLesson", b =>
                {
                    b.HasOne("PTScheduler.Domain.Entities.AcademyModule", "Module")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.AcademyLessonProgress", b =>
                {
                    b.HasOne("PTScheduler.Domain.Entities.AcademyLesson", "Lesson")
                        .WithMany("Progress")
            ...
            modelBuilder.Entity("PTScheduler.Domain.Entities.Order", b =>
                {
                    b.HasOne("PTScheduler.Domain.Entities.Product", "Product")
                        .WithMany("Orders")
