        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoursesEnabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SetupMode = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "CoursesEnabled", "Currency", "CustomDomain", "Description", "IsActive", "IsFeatured", "MaxClients", "MonthlyPrice", "Name", "PaymentsEnabled", "PrioritySupport", "SortOrder", "YearlyPrice" },
                values: new object[,]
                {
                    { "pro", true, "PLN", false, "Pełna funkcjonalność dla aktywnych trenerów", true, true, 50, 79m, "Pro", true, false, 2, 790m },
                    { "start", false, "PLN", false, "Dla trenera, który zaczyna", true, false, 3, 0m, "Start", false, false, 1, null },
                    { "studio", true, "PLN", true, "Bez limitów, własna domena, priorytetowe wsparcie", true, false, 2147483647, 149m, "Studio", true, true, 3, 1490m }
                });
