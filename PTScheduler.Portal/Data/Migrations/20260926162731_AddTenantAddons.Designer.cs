...
namespace PTScheduler.Portal.Data.Migrations
{
    ...
    [Migration("20260926162731_AddTenantAddons")]
    partial class AddTenantAddons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.AppFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.GoogleCalendarGrant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "UserKey")
                        .IsUnique();

                    b.ToTable("GoogleCalendarGrants");
                });
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.Plan", b =>
                {
                    ...
                    b.Property<bool>("ReferralProgram")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("TrainingPlansEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.ServiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "branding",
                            CreatedAt = new DateTime(2026, 8, 29, 12, 0, 0, 0, DateTimeKind.Utc),
                            CreditAmount = 0,
                            DefaultPrice = 30m,
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.ServiceOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.Tenant", b =>
                {
                    ...
                    b.Property<string>("BunnyLibraryApiKey")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("InternalSecret")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("LastActivityCheckedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.TenantAddon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.TenantCredit", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CreditType")
                        .IsUnique();
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.TenantMailCounter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TenantMailCounters");
                });

            modelBuilder.Entity("PTScheduler.Portal.Entities.TenantServicePrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "ServiceItemId")
                        .IsUnique();

                    b.ToTable("TenantServicePrices");
                });
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.PaymentRecord", b =>
                {
                    b.HasOne("PTScheduler.Portal.Entities.ServiceOrder", "ServiceOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("PTScheduler.Portal.Entities.ServiceOrder", b =>
                {
                    b.HasOne("PTScheduler.Portal.Entities.ServiceItem", "ServiceItem")
                        .WithMany()
